...
class RepoInfo {
  ...
  RepoInfo(this.user, this.repository);
}

class RepositoryDetailPage extends StatefulWidget {
  final RepoInfo repo;
  const RepositoryDetailPage({Key? key, required this.repo}) : super(key: key);
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  title: Text(widget.repo.repository),
                ),
              ),
...
const data = """[English](README.md) | 中文
