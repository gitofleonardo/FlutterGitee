...
EventResultEntity $EventResultEntityFromJson(Map<String, dynamic> json) {
	...
	final EventResultActor? actor = jsonConvert.convert<EventResultActor>(json['actor']);
	if (actor != null) {
		eventResultEntity.actor = actor;
	}
	final EventResultRepo? repo = jsonConvert.convert<EventResultRepo>(json['repo']);
	if (repo != null) {
	...
	final EventResultPayload? payload = jsonConvert.convert<EventResultPayload>(json['payload']);
	if (payload != null) {
...
EventResultPayload $EventResultPayloadFromJson(Map<String, dynamic> json) {
	...
	final EventResultPayloadTarget? target = jsonConvert.convert<EventResultPayloadTarget>(json['target']);
	if (target != null) {
	...
	final List<EventResultPayloadCommit>? commits = jsonConvert.convertListNotNull<EventResultPayloadCommit>(json['commits']);
	if (commits != null) {
	...
	final EventResultPayloadComment? comment = jsonConvert.convert<EventResultPayloadComment>(json['comment']);
	if (comment != null) {
		eventResultPayload.comment = comment;
	}
	final EventResultPayloadIssue? issue = jsonConvert.convert<EventResultPayloadIssue>(json['issue']);
	if (issue != null) {
...
EventResultPayloadComment $EventResultPayloadCommentFromJson(Map<String, dynamic> json) {
	final EventResultPayloadComment eventResultPayloadComment = EventResultPayloadComment();
	final EventResultPayloadCommentUser? user = jsonConvert.convert<EventResultPayloadCommentUser>(json['user']);
	if (user != null) {
...
Map<String, dynamic> $EventResultPayloadCommentToJson(EventResultPayloadComment entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
...
EventResultPayloadCommentUser $EventResultPayloadCommentUserFromJson(Map<String, dynamic> json) {
	final EventResultPayloadCommentUser eventResultPayloadCommentUser = EventResultPayloadCommentUser();
	final int? id = jsonConvert.convert<int>(json['id']);
	if (id != null) {
...
Map<String, dynamic> $EventResultPayloadCommentUserToJson(EventResultPayloadCommentUser entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['id'] = entity.id;
	data['login'] = entity.login;
	data['name'] = entity.name;
...
EventResultPayloadIssue $EventResultPayloadIssueFromJson(Map<String, dynamic> json) {
	final EventResultPayloadIssue eventResultPayloadIssue = EventResultPayloadIssue();
	final String? number = jsonConvert.convert<String>(json['number']);
	if (number != null) {
...
Map<String, dynamic> $EventResultPayloadIssueToJson(EventResultPayloadIssue entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['number'] = entity.number;
	data['state'] = entity.state;
	data['title'] = entity.title;
...
EventResultPayloadCommit $EventResultPayloadCommitFromJson(Map<String, dynamic> json) {
	final EventResultPayloadCommit eventResultPayloadCommit = EventResultPayloadCommit();
	final String? sha = jsonConvert.convert<String>(json['sha']);
	if (sha != null) {
		eventResultPayloadCommit.sha = sha;
	}
	final EventResultPayloadCommitAuthor? author = jsonConvert.convert<EventResultPayloadCommitAuthor>(json['author']);
	if (author != null) {
...
Map<String, dynamic> $EventResultPayloadCommitToJson(EventResultPayloadCommit entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['sha'] = entity.sha;
...
EventResultPayloadCommitAuthor $EventResultPayloadCommitAuthorFromJson(Map<String, dynamic> json) {
	final EventResultPayloadCommitAuthor eventResultPayloadCommitAuthor = EventResultPayloadCommitAuthor();
...
Map<String, dynamic> $EventResultPayloadCommitAuthorToJson(EventResultPayloadCommitAuthor entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
...
EventResultPayloadTarget $EventResultPayloadTargetFromJson(Map<String, dynamic> json) {
	final EventResultPayloadTarget eventResultPayloadTarget = EventResultPayloadTarget();
	final double? id = jsonConvert.convert<double>(json['id']);
	if (id != null) {
...
Map<String, dynamic> $EventResultPayloadTargetToJson(EventResultPayloadTarget entity) {
	final Map<String, dynamic> data = <String, dynamic>{};
	data['id'] = entity.id;
	data['login'] = entity.login;
	data['name'] = entity.name;
