...
BranchEntity $BranchEntityFromJson(Map<String, dynamic> json) {
  ...
  final BranchCommit? commit =
      jsonConvert.convert<BranchCommit>(json['commit']);
  if (commit != null) {
  ...
  final String? protectionUrl =
      jsonConvert.convert<String>(json['protection_url']);
  if (protectionUrl != null) {
    branchEntity.protectionUrl = protectionUrl;
  }
  return branchEntity;
}
...
Map<String, dynamic> $BranchEntityToJson(BranchEntity entity) {
  ...
  data['protection_url'] = entity.protectionUrl;
  return data;
}
