...
class JsonConvert {
  ...
  static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
    ...
    if (type == (NotificationMessageEntity).toString()) {
      return NotificationMessageEntity.fromJson(json) as M;
    }
    if (type == (NotificationMessageList).toString()) {
      return NotificationMessageList.fromJson(json) as M;
    }
    if (type == (NotificationMessageListActor).toString()) {
      return NotificationMessageListActor.fromJson(json) as M;
    }
    if (type == (NotificationMessageListRepository).toString()) {
      return NotificationMessageListRepository.fromJson(json) as M;
    }
    if (type == (NotificationMessageListRepositoryNamespace).toString()) {
      return NotificationMessageListRepositoryNamespace.fromJson(json) as M;
    }
    if (type == (NotificationMessageListRepositoryOwner).toString()) {
      return NotificationMessageListRepositoryOwner.fromJson(json) as M;
    }
    if (type == (NotificationMessageListRepositoryAssigner).toString()) {
      return NotificationMessageListRepositoryAssigner.fromJson(json) as M;
    }
    if (type == (NotificationMessageListSubject).toString()) {
      return NotificationMessageListSubject.fromJson(json) as M;
    }
    if (type == (NotificationMessageListNamespaces).toString()) {
      return NotificationMessageListNamespaces.fromJson(json) as M;
    }
    if (type == (UserMessageEntity).toString()) {
      return UserMessageEntity.fromJson(json) as M;
    }
    if (type == (UserMessageList).toString()) {
      return UserMessageList.fromJson(json) as M;
    }
    if (type == (UserMessageListSender).toString()) {
      return UserMessageListSender.fromJson(json) as M;
    }
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<NotificationMessageEntity>[] is M) {
      return data
          .map<NotificationMessageEntity>(
              (Map<String, dynamic> e) => NotificationMessageEntity.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageList>[] is M) {
      return data
          .map<NotificationMessageList>(
              (Map<String, dynamic> e) => NotificationMessageList.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListActor>[] is M) {
      return data
          .map<NotificationMessageListActor>((Map<String, dynamic> e) =>
              NotificationMessageListActor.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListRepository>[] is M) {
      return data
          .map<NotificationMessageListRepository>((Map<String, dynamic> e) =>
              NotificationMessageListRepository.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListRepositoryNamespace>[] is M) {
      return data
          .map<NotificationMessageListRepositoryNamespace>(
              (Map<String, dynamic> e) =>
                  NotificationMessageListRepositoryNamespace.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListRepositoryOwner>[] is M) {
      return data
          .map<NotificationMessageListRepositoryOwner>(
              (Map<String, dynamic> e) =>
                  NotificationMessageListRepositoryOwner.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListRepositoryAssigner>[] is M) {
      return data
          .map<NotificationMessageListRepositoryAssigner>(
              (Map<String, dynamic> e) =>
                  NotificationMessageListRepositoryAssigner.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListSubject>[] is M) {
      return data
          .map<NotificationMessageListSubject>((Map<String, dynamic> e) =>
              NotificationMessageListSubject.fromJson(e))
          .toList() as M;
    }
    if (<NotificationMessageListNamespaces>[] is M) {
      return data
          .map<NotificationMessageListNamespaces>((Map<String, dynamic> e) =>
              NotificationMessageListNamespaces.fromJson(e))
          .toList() as M;
    }
    if (<UserMessageEntity>[] is M) {
      return data
          .map<UserMessageEntity>(
              (Map<String, dynamic> e) => UserMessageEntity.fromJson(e))
          .toList() as M;
    }
    if (<UserMessageList>[] is M) {
      return data
          .map<UserMessageList>(
              (Map<String, dynamic> e) => UserMessageList.fromJson(e))
          .toList() as M;
    }
    if (<UserMessageListSender>[] is M) {
      return data
          .map<UserMessageListSender>(
              (Map<String, dynamic> e) => UserMessageListSender.fromJson(e))
          .toList() as M;
    }
