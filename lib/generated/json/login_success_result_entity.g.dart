...
LoginSuccessResultEntity $LoginSuccessResultEntityFromJson(
    Map<String, dynamic> json) {
  final LoginSuccessResultEntity loginSuccessResultEntity =
...
Map<String, dynamic> $LoginSuccessResultEntityToJson(
    LoginSuccessResultEntity entity) {
